...
-- HOADON
insert into bills(date_bill, user_id, employee_id, price) values('2006-03-27','1','1',320000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-08-12','1','2',840000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-08-23','2','1',100000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-01-09','2','1',180000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-10-20','1','2',3800000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-10-16','1','3',2430000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-10-28','3','3',510000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-10-28','1','3',440000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-10-28','3','4',200000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-11-01','1','1',5200000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-11-04','4','3',250000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-11-30','5','3',21000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-12-12','6','1',5000);
insert into bills(date_bill, user_id, employee_id, price) values('2006-12-13','3','2',3150000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-01','6','1',910000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-01','7','2',12500);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-02','8','3',35000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-13','8','3',330000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-13','1','3',30000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-14','9','4',70000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-16','10','3',67500);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-16','7','3',7000);
insert into bills(date_bill, user_id, employee_id, price) values('2007-01-17','8','1',330000);
...
use quanly_canteen;
select *from bills where year(date_bill) = 2006;
select *from detail_bill d where d.bill_id = 1;
 
drop database QUANLY_CANTEEN;