...
public class Product {
	...
	public Product(int id, String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId,
			Status status, boolean isDelete, List<DetailBill> details) {
	...
	public Product(int id, String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId, boolean isDelete) {
	...
	public Product(int id, String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId,
			Status status, boolean isDelete) {
	...
	public Product(String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId, boolean isDelete) {
